...
public class GetKoscomDAOList {
    ...
    public GetKoscomDAOList(String isuSrtCd, Integer isuCnt, Double trdPrc, String cmpprevddTpCd, Double opnprc, Double hgprc, Double lwprc, Integer accTrdvol, Integer accTrdval,
                            Long mktcap, Double cmpprevddPrc, Integer listShrs){
