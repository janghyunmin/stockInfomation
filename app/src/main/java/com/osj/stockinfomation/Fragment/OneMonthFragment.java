...
import com.osj.stockinfomation.databinding.FragmentOnemonthBinding;
import com.osj.stockinfomation.util.LogUtil;

import java.util.ArrayList;
import java.util.List;

public class OneMonthFragment extends Fragment implements View.OnClickListener , SwipeRefreshLayout.OnRefreshListener{
    FragmentOnemonthBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_onemonth, container, false);
        ...
        mPresenter.getProfitList(1, new CommonCallback.SingleObjectCallback<ProfitDAO>() {
            @Override
