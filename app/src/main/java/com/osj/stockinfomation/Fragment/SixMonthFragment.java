...
import com.osj.stockinfomation.databinding.FragmentSixmonthBinding;
import com.osj.stockinfomation.util.LogUtil;

import java.util.ArrayList;
import java.util.List;

public class SixMonthFragment extends Fragment implements View.OnClickListener , SwipeRefreshLayout.OnRefreshListener{
    FragmentSixmonthBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_sixmonth, container, false);
        ...
        mPresenter.getProfitList(6, new CommonCallback.SingleObjectCallback<ProfitDAO>() {
            @Override
